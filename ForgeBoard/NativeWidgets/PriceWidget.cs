...
namespace ForgeBoard.NativeWidgets
{
    internal class PriceWidget : BarExtension
    {
        public PriceWidget()
        {
            ...
            Description = "Displays live price on the bar and provides abilities to trade";
        }
        ...
        public override void MenuClick()
        {
            ...
            var priceView = new ForgeBoard.Views.Widgets.PriceWidget();
            ForgeBoardInteractions.AddWidgetToBar(priceView, string.Empty, false);
        }
